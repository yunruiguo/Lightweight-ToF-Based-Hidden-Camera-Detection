...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/spycamera.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '../../models/spycamera_yolov5s_best.pt', help='model.pt path(s)')
